	...
	<section>
		<div class="content">
			...
			<ul>
				...
				<li>
					I build new (mostly creative tech) communities wherever I end up living. They're my fam
					💖.
				</li>
			</ul>
		</div>
...
<style>
	...
	.profile-sticker {
		...
		background-image: url('$lib/img/tabs_profile.png');
	...
	.guitar-sticker {
		transform: rotate(5deg);
		background-image: url('$lib/img/me_guitars.jpg');
